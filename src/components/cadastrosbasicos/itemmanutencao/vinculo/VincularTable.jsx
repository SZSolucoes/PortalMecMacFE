...
class VincularTable extends Component {
    ...
    async onClickConfirm() {
        ...
        if (this.props.itemid && selectRow.selected && selectRow.selected[0] !== '') {
            const itemmanutID = this.props.itemid;
            ...
            this.props.modifyModalMessage(
                `Confirma o vínculo para ${selectRow.selected.length === 1 ? 'o veículo selecionado': 'os véiculos selecionados'} ?`
            );
